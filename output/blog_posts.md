...
## [A gallery of randomly generated art](//jamesma100.github.io/2025/randomart-gallery/)
...
## [List of WISCERS 2024 Faculty Mentors](https://www.noguera.dev/blog/2024/12/09/list-of-wiscers-2024-faculty-mentors/)
*By Blog on Michael Noguera on 2024-12-09*

I participated in Wisconsin Science and Computing Emerging Research Stars WISCERS as part of the 2022-23 cohort and really enjoyed the experience. Even if you&rsquo;re uncertain, you should definetl...

---

## [In defense of bad grammar](//jamesma100.github.io/2024/bad-grammar/)
...
## [Currying C functions using a heap-based trampoline](//jamesma100.github.io/2024/currying-in-c/)
...
## [Simple backpropogation in Python and numpy](//jamesma100.github.io/2024/implementing-backpropogation/)
...
## [Deriving backpropogation from scratch](//jamesma100.github.io/2024/deriving-backpropogation/)
...
## [Traversing dependency trees in Bazel](//jamesma100.github.io/2024/introducing-bazelvis/)
...
## [Overview of the x86 call stack](//jamesma100.github.io/2024/x86-calling-convention/)
...
## [False sharing in practice](//jamesma100.github.io/2024/false-sharing/)
...
## [Exploring the Anshel-Anshel-Goldfeld Key Exchange System](https://www.noguera.dev/blog/2022/12/28/exploring-the-anshel-anshel-goldfeld-key-exchange-system/)
...
## [A CS Course Map for Incoming UW-Madison Students](https://www.noguera.dev/course-map/)
...
## [Hugo Shortcode: License Badges on Code Blocks](https://www.noguera.dev/blog/2021/12/22/hugo-shortcode-license-badges-on-code-blocks/)
*By Blog on Michael Noguera on 2021-12-22*

One of my favorite features of the static site generator Hugo is &ldquo;shortcodes&rdquo;, which allow you to abstract away chunks of website content and invoke them from your markdown posts. The Hugo...
...
## [AP Chem: Spectrophotometric Mixture Analysis](https://www.noguera.dev/blog/2020/01/14/ap-chem-spectrophotometric-mixture-analysis/)
*By Blog on Michael Noguera on 2020-01-14*

To determine the composition of a mystery mixture consisting of various types of food coloring, I wrote this program that works with Vernier&rsquo;s Spectral Analysis software.

---

## [Zybooks Autoplay](https://www.noguera.dev/blog/2019/10/04/zybooks-autoplay/)
...
## [TJCTF 2019: All The Zips](https://www.noguera.dev/blog/2019/04/06/tjctf-2019-all-the-zips/)
...
## [Reverse Engineering the Wisconsin Driver Practice Test](https://www.noguera.dev/blog/2019/04/04/reverse-engineering-the-wisconsin-driver-practice-test/)
*By Blog on Michael Noguera on 2019-04-04*

Note from a future me, after I took the test: It&rsquo;s pretty easy but it tries to trick you. Glance over these questions because they were good to know. The Problem I am currently taking Drivers&rs...

---

## [Hack This Site: Basic Challenges](https://www.noguera.dev/blog/2018/12/03/hack-this-site-basic-challenges/)
*By Blog on Michael Noguera on 2018-12-03*

Basic 1: HTML Comment This level is what we call &ldquo;The Idiot Test&rdquo;, if you can&rsquo;t complete it, don&rsquo;t give up on learning all you can, but, don&rsquo;t go begging to someone else...

---

## [How To: Blind SQL Injection, HSCTF 2018: Password](https://www.noguera.dev/blog/2018/07/19/how-to-blind-sql-injection-hsctf-2018-password/)
*By Blog on Michael Noguera on 2018-07-19*

Here are some rudimentary notes on how I solved the challenge &lsquo;Password&rsquo; for HSCTF 2018. The puzzle gave a mock-up social media website with a login form, and asked that you retrieve Keith...

---

## [Making backups of hard drives using the bash utility “dd”](https://www.noguera.dev/blog/2018/07/18/making-backups-of-hard-drives-using-the-bash-utility-dd/)
